...
Die 301-Conf wurde von René auf zoro deployt (Backup `mapraiders.bak_20260610_131521`, nginx -t ok, Include 4× nach server_name-Zeilen). **Finaler Volltest: 305/305 bestanden**: jede Quelle antwortet 301 direkt auf das Soll-Ziel, jedes Ziel 200, keine Redirect-Ketten; Unicode-Pfade dekodiert und percent-encoded verifiziert. Anschließend: 195 Stub-Dateien nach `docs/_retired/` archiviert, 103 interne Links von Stub-URLs auf finale Ziele umgeschrieben (Commit d06debc). AP1 = **Definition of Done erfüllt** (0 Meta-Refresh-Stubs im Auslieferungsbestand, alle Alt-URLs 301→200).

Optionale Verbesserung (niedrig): 5 traditionell-chinesische /zh/-Slugs (尋寶遊戲 u. a.) zielen per Stub-Vorgabe auf /zh-cn/ (vereinfacht); semantisch passender wäre /zh-tw/.
