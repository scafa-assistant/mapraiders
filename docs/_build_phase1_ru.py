...
TESTER_RON = {
    ...
    "quote": "Собака всё равно требует двух прогулок в день, теперь я просто беру с собой телефон с открытым приложением. Звучит глупо, но каждый вечер проверяю, всё ли ещё синее.",
    "date": "2026-03-15",
...
TESTER_VIVIAN = {
    ...
    "quote": "Я и так бегаю каждое утро, но теперь я ещё что-то и защищаю. Мой круг вокруг Альстера принадлежит мне, и пусть так и остаётся. Странно, сколько дисциплины это вдруг включает.",
    "date": "2026-03-22",
...
TESTER_ALJOSCHA = {
    ...
    "quote": "Оставляешь короткую аудиозапись у входа в подъезд, через три дня её находит кто-то, кого ты не знаешь. Для игры это ощущается странно близко.",
    "date": "2026-04-01",
...
FOUNDER_QUOTE = (
    "Я играл в Pokémon GO три года и в какой-то момент бросил. То, чего мне не хватало, "
    "так и не появилось: настоящая земля вместо залов, которые исчезают через пару часов. "
    "Когда в 2025 году произошла саудовская сделка, для меня стало понятно, что путь Niantic "
    "идёт не туда, куда мне интересно. Поэтому MapRaiders я делаю сам. Без рекламы, без давления "
    "инвесторов, без обязательной подписки. Мой район это моё поле; ваш можете забрать вы."
)
...
{cards}
    ...
    <p style="margin-top:24px;font-size:12px;color:var(--dim);max-width:680px;line-height:1.6">
      Примечание: тестеры это участники закрытой беты. По их просьбе указываем имя и инициал, не больше. Отзывы написаны на немецком, на русский переведены; в Schema.org это помечено через <code>translationOfWork</code>.
    </p>
  </div>
</section>"""
...
<div class="mx">
  ...
  <p class="f-copy">&copy; 2026 MapRaiders. Твоя улица, твоя территория. Scafa Investments LLC.</p>
</div>
</footer>
<script>
...
<div class="mx">
  ...
  <div class="prose rv d2">
    <p>Три бета-тестера из Германии: владелец собаки, бегунья и городской исследователь. Они пользовались MapRaiders несколько недель в обычной рутине. Отзывы переведены с немецких оригиналов и принадлежат реальным людям из закрытой беты. В Schema.org это помечено через <code>translationOfWork</code>.</p>
  </div>
</div>
</section>"""
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">5,0 / 5 – <em>3 проверенных бета-отзыва</em></h2>
  <div class="prose rv d2">
    <p>Отзывы собраны в закрытой бета-фазе с февраля по апрель 2026 года. Тестировали в Штутгарте (Ron, прогулки с собакой), в Гамбурге (Vivian, утренние пробежки) и в Берлине (Aljoscha, городские маршруты). Никаких искусственных тест-сессий, только обычная рутина. Отзывы переведены с немецких оригиналов, в Schema.org помечено через <code>translationOfWork</code>.</p>
  </div>
</div>
</section>"""
...
K1 = {
    ...
    "meta": "Игра территорий MapRaiders: GPS-MMO с настоящим, постоянным владением землёй. Без рекламы, бесплатно, работает везде, где есть GPS, без VPN.",
    ...
    "lead": "MapRaiders превращает реальную GPS-площадь в настоящую территорию. Захватываешь шагами, защищаешь мини-играми, удерживаешь вместе с кланом. Без рекламы, без P2W, без обязательной премиум-подписки. Работает везде, где есть GPS, без VPN.",
    "trigger": {
        "quote": "Собака всё равно требует двух прогулок в день, теперь я просто беру с собой телефон с открытым приложением. Звучит глупо, но каждый вечер проверяю, всё ли ещё синее.",
        "author": "Ron C., владелец собаки из района Штутгарта (закрытая бета)"
    },
...
K2 = {
    ...
    "trigger": {
        "quote": "Pokémon GO ушёл из России в марте 2022 года. С MapRaiders проблема региональной блокировки в эту сторону снимается, потому что мы не Niantic.",
        "author": "René Scafarti, основатель MapRaiders"
    },
    "testers": ALL_TESTERS,
    "sections": [
        {
...
K3 = {
    ...
    "lead": "В марте 2022 года Niantic официально отключил Pokémon GO в России и Беларуси. Миллионы игроков остались без любимой игры и без удобного решения. Если вы в их числе, мы вас принимаем: MapRaiders заполняет эту пустоту настоящей территорией вместо мимолётных залов, работает везде, где есть GPS, без VPN и без зависимости от одного западного издателя.",
    "trigger": {
        "quote": "Если вы потеряли свой аккаунт Pokémon GO в марте 2022 года, мы это понимаем. Заменить тех покемонов мы не можем, но дать землю под ногами, которая никуда не денется по чужой команде, можем.",
        "author": "René Scafarti, основатель MapRaiders"
    },
    "testers": ALL_TESTERS,
    "sections": [
    ...
    <p>Многие игроки потеряли годы прогресса: покемонов, вложения в Battle Pass, местные сообщества. Возврата средств для большинства не было. Мы знаем, что переход на новую игру это не «давайте начнём сначала», а «верните мне то, что у меня было». Полностью вернуть мы не можем, но можем дать что-то своё, и сделать так, чтобы оно не исчезло за одну ночь по чужому решению.</p>
            """,
        },
        {
...
K4 = {
    ...
    "lead": "Draconius Go от российской команды это крепкая гео-игра в духе сбора существ, и для русскоязычного рынка она остаётся главным «своим». MapRaiders играет в другом жанре: настоящие территории на карте, мини-игры защиты, кланы из соседей. Мы не приходим вместо Draconius. Мы приходим рядом: если вам нужны и существа, и земля, держите оба приложения на телефоне, они не мешают друг другу.",
    "trigger": {
        "quote": "Draconius Go делают свою часть рынка хорошо. Мы делаем другую: вместо коллекции существ вы получаете кусок реальной карты, который надо удерживать. Жанры разные, можно держать обе.",
        "author": "René Scafarti, основатель MapRaiders"
    },
    ...
    <p>Мы не считаем Draconius Go конкурентом. Они делают свою часть рынка хорошо, мы делаем свою. Если вы уже играете в Draconius, попробуйте MapRaiders в фоне на тех же прогулках; одно другое не сломает.</p>
            """,
        },
    ],
    "faq": [
...
K5 = {
    ...
    "trigger": {
        "quote": "Я и так бегаю каждое утро, но теперь я ещё что-то и защищаю. Мой круг вокруг Альстера принадлежит мне, и пусть так и остаётся.",
...
K7 = {
    ...
    "trigger": {
        "quote": "Куда уходят ваши GPS-данные после марта 2025 года, вопрос уже не теоретический. У нас в этой цепочке нет ни саудовского фонда, ни Scopely, ни Niantic.",
        "author": "René Scafarti, основатель MapRaiders"
    },
    "testers": ALL_TESTERS,
    "sections": [
