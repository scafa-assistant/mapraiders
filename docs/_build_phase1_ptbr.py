...
TESTER_RON = {
    ...
    "quote": "Meu cachorro adora o passeio — e eu adoro que cada passeio torna meu bairro mais visível no mapa. Já conquistei minha rua toda.",
    "date": "2026-03-15",
    "id": "review-ron-c",
}
TESTER_VIVIAN = {
    ...
    "quote": "Já corro toda manhã. Com MapRaiders cada percurso tem um objetivo: manter território ou reconquistá-lo. Minha motivação cardio explodiu.",
    "date": "2026-03-22",
    "id": "review-vivian-n",
}
TESTER_ALJOSCHA = {
    ...
    "quote": "Deixar Echos e ver quem os encontra é como uma caça ao tesouro aberta pela cidade inteira.",
    "date": "2026-04-01",
...
FOUNDER_QUOTE = (
    "Eu era um dos jogadores frustrados de Pokémon GO. Queria território de verdade, não captura "
    "passageira de ginásio. Não queria meus passos vendidos a fundos sauditas, sem modelo de "
    "propaganda, sem assinatura premium obrigatória. Por isso construí o MapRaiders. Esse é o meu "
...
<div class="mx">
  ...
  <p class="f-copy">&copy; 2026 MapRaiders &mdash; Conquiste seu bairro de verdade. Um produto da Scafa Investments LLC.</p>
</div>
</footer>
<script>
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">5,0 de 5 — <em>3 avaliações verificadas da beta</em></h2>
  <div class="prose rv d2">
    <p>Três testadores da beta fechada — um tutor de cachorro, uma corredora e um explorador urbano — usaram o MapRaiders por várias semanas. Os depoimentos a seguir representam pessoas reais da beta fechada (Alemanha). As avaliações foram traduzidas dos originais em alemão para o português brasileiro. Por motivos de privacidade, usamos apenas o primeiro nome + inicial.</p>
  </div>
</div>
</section>"""
...
<div class="mx">
  ...
  <div class="prose rv d2">
    <p>Aqui você encontra todas as 7 páginas Killer mais 7 avaliações detalhadas que iluminam o MapRaiders sob diferentes ângulos — da comparação com Pokémon GO ao app de caça ao tesouro, do jogo de território ao companheiro de corrida. Cada página é independente; juntas, elas formam o quadro completo.</p>
  </div>
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">5,0 de 5 — <em>3 avaliações verificadas da beta</em></h2>
  <div class="prose rv d2">
    <p>Todas as avaliações vêm da fase de beta fechada (fevereiro–abril de 2026). Três testadores — um tutor de cachorro, uma corredora e um explorador urbano — testaram o MapRaiders em rotas próprias em Stuttgart, Hamburgo e Berlim. As avaliações exibidas aqui foram traduzidas dos originais em alemão e representam pessoas reais.</p>
  </div>
</div>
</section>"""
...
K1 = {
    ...
    "pricing_pill": "R$ 0,00 gameplay · Cosmético opcional a partir de R$ 4,90",
    "h1_html": 'Alternativa Pokémon GO grátis — sem propaganda, <em>sem fake GPS</em>, sem fundo saudita',
    "lead": "Quem busca uma alternativa ao Pokémon GO sem Battle Pass, sem loucura de Remote Raid Pass e sem propaganda, geralmente cai na próxima armadilha premium. MapRaiders inverte isso: o gameplay completo é e continua gratuito. Sem níveis, sem assinatura obrigatória, sem venda de dados — pagamento via PIX para os cosméticos opcionais.",
    "trigger": {
    ...
    <ul>
      ...
      <li><strong>Polêmica do Remote Raid Pass.</strong> A Niantic aumentou preços e reduziu disponibilidade — uma onda de jogadores brasileiros parou em 2023.</li>
      <li><strong>Aquisição saudita em março de 2025.</strong> A Niantic vendeu o Pokémon GO para a Scopely (subsidiária do Public Investment Fund saudita). Os dados de localização de milhões de jogadores agora chegam indiretamente a um fundo soberano estrangeiro.</li>
    </ul>
            """,
        },
        {
            ...
            "body": "<p>Tiers transparentes — sem paywall escondido, sem bloqueio de tutorial após 10 minutos:</p>",
  ...
  <p style="margin-top:24px;color:var(--muted);font-size:14px"><strong>Importante:</strong> Itens cosméticos não dão nenhuma vantagem no jogo. Quem não compra nada joga com mecânicas idênticas às do Apoiador Vitalício.</p>""",
        },
        {
            ...
            "body": """
    <p>Os cosméticos opcionais e a assinatura Apoiador podem ser pagos via PIX, cartão de crédito brasileiro ou carteira digital — sem precisar inserir dados de cartão internacional. PIX é a forma mais rápida: você abre o app do banco, escaneia o QR-Code, confirma e pronto. O cosmético desbloqueia em segundos.</p>
    <p>Provedores de pagamento integrados: Stripe BR, MercadoPago, dLocal, EBANX. Sem taxa adicional para o jogador, sem necessidade de PayPal.</p>
            """,
        },
        {
            ...
            "body": """
    <p>Em março de 2025, a Niantic vendeu sua divisão de jogos (Pokémon GO, Ingress, Pikmin Bloom, Monster Hunter Now) por 3,5 bilhões de dólares para a Scopely. A Scopely é uma subsidiária do Public Investment Fund (PIF) da Arábia Saudita — formalmente uma entidade controlada pelo estado saudita.</p>
    <p>Concretamente, isso significa: os <strong>dados de localização de cerca de 30 milhões de jogadores mensais de Pokémon GO</strong> — onde correm, quando passeiam com o cachorro, quais rotas percorrem todos os dias — agora são processados pela infraestrutura da Scopely. Os detalhes das transferências de dados não são publicamente divulgados. O que está claro: não há proteção LGPD-equivalente contra atores ligados a fundos soberanos fora do Brasil.</p>
    <p>MapRaiders é uma LLC dos EUA em <strong>propriedade privada</strong> (Scafa Investments LLC, Flórida), desenvolvida por uma equipe independente. Operamos servidores compatíveis com LGPD, não vendemos dados, não temos rede de propaganda conectada e não somos controlados por nenhum estado.</p>
            """,
        },
    ],
    "faq": [
        {"q": "MapRaiders é realmente grátis para sempre?",
         "a": "Sim. Todo o gameplay principal — conquistar territórios, deixar Echos, criar missões, formar clãs — continua grátis para sempre. Não há sistema de níveis, Battle Pass nem assinatura obrigatória."},
        ...
        {"q": "O que significa &ldquo;sem fundo saudita&rdquo;?",
         "a": "Em março de 2025, a Niantic vendeu sua divisão de jogos (Pokémon GO, Ingress, Pikmin Bloom, Monster Hunter Now) por 3,5 bilhões de dólares para a Scopely — subsidiária do Public Investment Fund saudita. Os dados de localização de mais de 30 milhões de jogadores mensais agora chegam indiretamente a um fundo soberano estrangeiro. MapRaiders é uma LLC privada dos EUA, não controlada por nenhum estado."},
    ],
    "internal_links": [
...
K2 = {
    ...
    "og_title": "Jogo de GPS 2026 — o GPS MMO honesto, gratuito",
    ...
    "lead": "Jogos de GPS deveriam ser mais que pontos efêmeros num mapa. MapRaiders combina GPS, captura persistente de território e um sistema de defesa que torna a conquista real possível. Você passa numa rua — ela é sua. Enquanto você defendê-la. Sem fake GPS, sem AR drenando bateria, sem propaganda.",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p>Um <strong>jogo de GPS (Location-Based Game)</strong> usa a posição geográfica do dispositivo como mecânica central. Diferente de jogos AR, que precisam adicionalmente da câmera, um jogo puro de GPS funciona apenas com o mapa — economizando bateria e protegendo a privacidade.</p>
    <p>MapRaiders é um <strong>GPS MMO</strong>: milhares de jogadores se movimentam simultaneamente no mesmo mapa, competem em tempo real e compartilham um sistema unificado de territórios. Sem AR, sem câmera, sem óculos VR.</p>
            """,
        },
        {
            "label": "Os 7 melhores",
            "title": "Os 7 melhores jogos de GPS comparados — e por que <em>MapRaiders</em> é o único com território real",
            "body": "<p>A maioria das listas joga junto apps que só compartilham uma característica com Pokémon GO. Aqui é honesto:</p>",
            "extra": """  <table class="comp-table rv d2">
    <thead>
    ...
    <tbody>
      ...
      <tr><td class="feat-name">MapRaiders</td><td>Scafa Investments LLC</td><td class="check">✓</td><td class="check">✓ persistente</td><td class="check">LGPD, independente</td></tr>
        ...
        {
            "label": "Diferencial",
            "title": "O que torna o MapRaiders <em>único</em>",
            "body": "",
            "extra": """  <div class="features-grid">
    <div class="feat-card rv"><h3>Territórios persistentes</h3><p>Ao conquistar uma rua, ela é sua — até alguém recapturá-la ou o decay agir. Sem ginásios passageiros.</p></div>
    <div class="feat-card rv d1"><h3>Echos em vez de AR</h3><p>Deixe Echos de áudio, foto ou vídeo em locais reais. Outros jogadores os descobrem. Sem AR drenando bateria.</p></div>
    <div class="feat-card rv d2"><h3>7 mini-jogos de defesa</h3><p>Em ataques: jogo da velha, pedra-papel-tesoura ou mini-xadrez. Estratégia em vez de só tempo.</p></div>
    <div class="feat-card rv d3"><h3>Clãs orgânicos</h3><p>Clãs surgem da vizinhança, não de servidores Discord. Quem corre na mesma rua vira aliado.</p></div>
    <div class="feat-card rv d4"><h3>Bateria poupada</h3><p>Só GPS, sem câmera, sem AR. 4× mais autonomia de bateria que Pokémon GO em rotas longas.</p></div>
  </div>""",
        },
        {
    ...
    <div class="feat-card rv d1"><h3>Corrida matinal</h3><p>Cardio com objetivo: defender território ou reconquistá-lo. Strava + jogo.</p></div>
    <div class="feat-card rv d2"><h3>Marcar o Carnaval</h3><p>Defina os blocos da sua rota de Carnaval. Eventos sazonais BR-exclusivos.</p></div>
    <div class="feat-card rv d3"><h3>Atividade família</h3><p>Caça ao tesouro com Echos, sem AR, sem propaganda — para crianças e adultos.</p></div>
  </div>""",
        },
    ],
    "faq": [
        {"q": "O que é um jogo de GPS?",
         "a": "Um jogo de GPS (Location-Based Game) usa sua posição GPS para acionar mecânicas de jogo. MapRaiders usa GPS para vincular territórios, Echos e missões a locais reais — sua cidade vira o campo de jogo."},
        {"q": "Preciso de Realidade Aumentada?",
         "a": "Não. MapRaiders é deliberadamente AR-free. Usa só GPS e o mapa. Isso poupa bateria e privacidade — sem câmera, sem captura facial."},
...
K3 = {
    ...
    "h1_html": 'Jogo de território — o único onde a <em>terra é realmente sua</em>',
    "lead": "Um jogo de território deveria ser mais que um ponto num mapa que some em 5 minutos. MapRaiders combina GPS, captura persistente de área e um sistema de defesa que torna a conquista real possível. Você anda numa rua — ela é sua. Enquanto defendê-la.",
    "trigger": {
        "quote": "Sua rua, seu território. Sem mensalidade.",
        "author": "MapRaiders, princípio da marca"
    },
    ...
    <p>As quatro mecânicas que definem um jogo de território real:</p>
    <ul>
      <li><strong>Persistência.</strong> Áreas conquistadas ficam atribuídas ao jogador ou clã até serem ativamente tomadas.</li>
      <li><strong>Decay.</strong> Territórios inativos encolhem com o tempo — ninguém bloqueia permanentemente sem jogar ativamente.</li>
      <li><strong>Defesa.</strong> Em ataque, um mini-jogo entre os dois jogadores decide — não comparação automática de stats.</li>
      <li><strong>Transferências de clã.</strong> Territórios podem ser passados a aliados ou clã — profundidade econômica.</li>
    </ul>
            """,
        },
        {
    ...
    <div class="feat-card rv d1"><h3>Decay Engine</h3><p>Quem não percorre regularmente um território vê ele encolhendo alguns por cento por dia. Atividade mantém a terra — não dinheiro.</p></div>
    <div class="feat-card rv d2"><h3>Mini-jogos de defesa</h3><p>7 mini-jogos diferentes decidem ataques: jogo da velha, pedra-papel-tesoura, mini-xadrez. Estratégia conta mais que tempo de jogo.</p></div>
    <div class="feat-card rv d3"><h3>Territórios de clã</h3><p>Vários jogadores podem manter um território juntos. Áreas de clã são mais robustas — um único atacante não basta para romper.</p></div>
        ...
        },
        {
            ...
            "body": """
    <p><strong>Capturas de ginásio do Pokémon GO</strong> são passageiras: quem mantém um recorde por algumas horas ganha moedas — mas o território em si não pode ser entendido como posse de terra. O ginásio é um ponto, não uma área.</p>
    <p><strong>Portais do Ingress</strong> são similares: pontos que se conectam por links em triângulos. O jogo conhece campos entre portais, mas não posse persistente de terra. Quem fica uma semana sem abrir o app não perde &ldquo;seu bairro&rdquo; — ele nunca foi realmente atribuído.</p>
    <p>MapRaiders ataca exatamente nesse ponto: o <strong>território é o recurso de jogo</strong>, não o ponto sobre ele. Você ganha terra, perde terra, transfere terra — como num jogo espacial real.</p>
            """,
        },
    ],
    "faq": [
        {"q": "Como funciona o sistema de territórios no MapRaiders?",
         "a": "Você anda fisicamente por ruas e reivindica áreas GPS. Esses territórios aparecem no mapa ao vivo e são seus — enquanto nenhum outro jogador passar por lá e desafiar. Se você defender com sucesso, a área permanece sua."},
        ...
        {"q": "O que acontece num ataque territorial?",
         "a": "O atacante precisa chegar fisicamente ao seu território. Então um mini-jogo interativo começa — defensor e atacante jogam um contra o outro. Quem ganhar o mini-jogo decide o destino da área."},
        ...
        {"q": "O jogo de território cobra alguma coisa?",
         "a": "Não. Todo o gameplay de território é gratuito. Opcionalmente há itens cosméticos (R$ 4,90 – R$ 49,90) para designs de marcador e cores de território — sem vantagens no jogo. Pagamento via PIX."},
    ],
    "internal_links": [
        ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
        ("/pt-br/alternativa-pokemon-go-gratis.html", "Alternativa Pokémon GO grátis"),
...
K4 = {
    ...
    "og_title": "Pokémon GO sem fake GPS — onde andar é o jogo",
    ...
    "lead": "Quem joga Pokémon GO no Brasil conhece o problema: PokéParadas concentradas só em centros, falta de spawns no bairro, raids sem ninguém. A solução de muitos virou fake GPS — PGSharp, MocPOGO, iMyFone. Mas trapacear é cansativo, arriscado (banimento) e mata o sentido do jogo. MapRaiders elimina a necessidade de fake GPS porque o território está em qualquer lugar com sinal GPS. Aqui andar é o jogo.",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p>O mercado negro brasileiro de cheats para Pokémon GO é grande e ativo — não por preguiça dos jogadores, mas por problemas estruturais do jogo no Brasil:</p>
    <ul>
      ...
      <li><strong>Raids sem participantes.</strong> Em horário de trabalho, raids ficam vazias — sem time, sem captura. Fake GPS leva o jogador virtualmente ao centro onde há gente.</li>
      ...
      <li><strong>Custos acumulados.</strong> Battle Pass, Remote Raid Pass, eier-incubadores. Trapacear vira atalho financeiro tentador.</li>
    </ul>
            """,
        },
        {
    ...
    <ul>
      <li><strong>Território está em qualquer lugar.</strong> Sem dependência de pontos pré-definidos. Cada rua, cada bloco, cada parque é território potencial.</li>
      <li><strong>Persistência supera presença.</strong> Você não precisa estar &ldquo;onde estão os outros&rdquo;. Quem corre toda manhã na mesma rua, possui essa rua. Defesa ativa &gt; spawn farming.</li>
      <li><strong>Echos abrem qualquer canto.</strong> Você deixa Echos onde quiser; outros jogadores os descobrem. Suas ruas viram destino — não periferia.</li>
      <li><strong>Mini-jogos de defesa &gt; presença horária.</strong> Você não precisa &ldquo;estar lá agora&rdquo; — quando alguém ataca seu território, você joga o mini-jogo defensivo onde estiver.</li>
    </ul>
            """,
        },
        {
  ...
  <p style="margin-top:24px;color:var(--muted);font-size:14px"><strong>Resumo:</strong> No MapRaiders, o jogo respeita seu lugar. Não exige que você fake estar em São Paulo. Sua rua, suas conquistas. Honesto.</p>""",
        },
    ],
    "faq": [
        {"q": "O MapRaiders detecta fake GPS?",
         "a": "Sim. Detectamos fake GPS, joystick simulado e velocidades impossíveis. Trapaça é detectada e leva a banimento. Mas a maior detecção é o próprio design: não há razão para usar fake GPS porque o jogo respeita sua localização real."},
        {"q": "Por que não preciso de PGSharp ou MocPOGO?",
         "a": "Porque o MapRaiders não depende de PokéStops centralizados ou raids agendados. Cada rua é território potencial, cada bloco vira terreno seu se você passar por lá regularmente. A periferia não é desvantagem — é vantagem (menos competição)."},
        ...
        {"q": "Posso jogar de casa, sem sair?",
         "a": "Não. MapRaiders exige movimento real. Aqui andar é o jogo. Mas você não precisa caminhar km — começa com a quadra de casa, expande no ritmo natural do dia (passear cachorro, ir trabalhar a pé, correr)."},
        {"q": "É 100% gratuito?",
         "a": "Sim. Gameplay completo grátis. Cosméticos opcionais via PIX (R$ 4,90 – R$ 49,90) sem vantagem competitiva."},
    ],
    "internal_links": [
        ("/pt-br/alternativa-pokemon-go-gratis.html", "Alternativa Pokémon GO grátis"),
        ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
...
K5 = {
    ...
    "og_title": "App de caminhada com jogo — cardio + jogo + saúde",
    ...
    "badge": "Cardio + Jogo",
    "pricing_pill": "Free Forever · 4× menos bateria que Pokémon GO",
    "h1_html": 'App de caminhada com jogo — quando <em>cada passo</em> conquista território',
    "lead": "Apps de caminhada dão estatísticas. Jogos de caminhada como Pokémon GO dão coleção. Mas nenhum app transforma seu caminho real em terra real. MapRaiders sim: cada passo forma território, cada volta o defende. Cardio com consequência. Família junta. Saúde de verdade.",
    "trigger": {
        "quote": "Já corro toda manhã. Com MapRaiders cada percurso tem um objetivo: manter território ou reconquistá-lo. Minha motivação cardio explodiu.",
    ...
    "sections": [
        {
            ...
            "body": """
    <p>Strava, Nike Run Club, Adidas Running — medem tempo, distância, ritmo. Mas três pontos faltam para muitos brasileiros:</p>
    <ul>
      <li><strong>Sem elemento de jogo.</strong> Quem não persegue recordes pessoais perde motivação em 4 semanas.</li>
      <li><strong>Pressão de performance.</strong> Leaderboards públicos desmotivam mais do que ajudam.</li>
      <li><strong>Forçar assinatura.</strong> Strava Premium R$ 21,90/mês para mapas de calor e comparações de rotas que ficam inúteis no plano gratuito.</li>
    </ul>
            """,
        },
        {
            ...
            "body": "",
            "extra": """  <div class="features-grid">
    <div class="feat-card rv"><h3>Manter território</h3><p>Cada percurso defende terra. Quem para 3 dias vê o decay agir — incentivo natural ao retorno.</p></div>
    <div class="feat-card rv d1"><h3>Contador de Decay</h3><p>O valor de Decay mostra: &ldquo;Se não correr hoje, seu bairro encolhe X%&rdquo;. Sem culpa — só realidade física.</p></div>
    ...
    <div class="feat-card rv d3"><h3>Recompensa via Echo</h3><p>Echos de áudio quando você passa. Outros jogadores contam histórias da rua — sem propaganda, sem influencer.</p></div>
        ...
        },
        {
            ...
            "body": """
    <p>O MapRaiders não compete com o Strava em métricas de performance. Você pode rodar os dois apps ao mesmo tempo, eles usam o mesmo sensor GPS sem conflito. O que o Strava não dá: território real e defesa social. O que o MapRaiders não dá: análise detalhada de pace splits e zonas cardíacas.</p>
    <p>Combinação ideal: <strong>Strava para análise técnica, MapRaiders para motivação diária e território.</strong> Roda os dois, sem dor.</p>
            """,
        },
        {
            "label": "50+ longevidade",
            "title": "Caminhada para <em>50+ anos</em> — longevidade BR",
            "body": """
    <p>O Brasil tem mais de 25 milhões de pessoas com 60+. Caminhada é a atividade física mais recomendada por geriatras — mas falta motivação. MapRaiders resolve isso sem AR (que confunde) e sem competição agressiva (que afasta):</p>
    <ul>
      <li><strong>Ritmo próprio.</strong> Sem mínimo de velocidade. Walking, caminhar com bengala, com amigo — tudo conta para território.</li>
      ...
      <li><strong>LGPD-compatível.</strong> Para idosos preocupados com privacidade — sem propaganda direcionada, sem venda de localização.</li>
    </ul>
            """,
        },
    ],
    "faq": [
        {"q": "Quanto tempo de bateria dura?",
         "a": "Em uma caminhada de 1 hora, tipicamente 15-25% de bateria (vs ~50% no Pokémon GO com AR). Os valores variam conforme aparelho e brilho da tela."},
        {"q": "Funciona com Strava ou Nike Run Club?",
         "a": "Atualmente sem integração direta. Você pode rodar ambos os apps ao mesmo tempo — eles usam o mesmo sensor GPS sem conflito. Integração Strava planejada para Q4 2026."},
        {"q": "Walking devagar também conta?",
         "a": "Sim. Não há velocidade mínima. Walking, caminhada lenta, passeio — tudo forma território, desde que haja movimento físico real (sem auto-cheating)."},
        {"q": "Pode usar idoso?",
...
K6 = {
    ...
    "lead": "Apps tradicionais de caça ao tesouro como Geocaching exigem assinatura premium e tours pré-definidos. MapRaiders inverte isso: Echos já estão espalhados pela cidade inteira. Você segue rastros de outros jogadores ou deixa os seus. Ao vivo, gratuito, sem comprar tour, sem preparação. Brasileiríssimo.",
    "trigger": {
        "quote": "Deixar Echos e ver quem os encontra é como uma caça ao tesouro aberta pela cidade inteira.",
    ...
    <tbody>
      <tr><td class="feat-name">Geocaching</td><td>Sub Premium ~R$ 30/mês</td><td>Baixa — achar caches</td><td class="cross">Assíncrono</td><td>Coletar</td></tr>
      ...
      <tr><td class="feat-name">MapRaiders</td><td class="check">R$ 0,00</td><td class="check">Zero</td><td class="check">Ao vivo</td><td>Echos + Missões + Território</td></tr>
        ...
        },
        {
            ...
            "body": """
    <p>Em vez de uma tour linear da estação 1 à 10, o MapRaiders cria uma <strong>caça ao tesouro espacial aberta</strong> — a cidade inteira é o playground:</p>
    <ul>
      ...
      <li><strong>Criar missões.</strong> Crie uma tarefa pequena num local (&ldquo;Tire foto da porta vermelha lá&rdquo;). Outros jogadores cumprem.</li>
      <li><strong>Camada de território.</strong> Quem percorre uma rota de caça ao tesouro frequentemente, conquista como território — os rastros viram terra.</li>
    </ul>
            """,
        },
        {
            ...
            "body": """
    <p>Caça ao tesouro é cultura brasileira de infância — pistas com giz, rastro de folhas, esconderijo final com bala. MapRaiders traz isso para a era do smartphone, sem deixar crianças sozinhas na tela:</p>
    <ul>
      ...
      <li><strong>LGPD-compatível para crianças.</strong> Sem rastreador de propaganda personalizada, sem venda de dados, sem chat in-app sem aprovação dos pais.</li>
    ...
    "faq": [
        {"q": "MapRaiders é apropriado para crianças?",
         "a": "Sim, a partir de 9 anos com acompanhamento dos pais. O app é compatível com LGPD, sem propaganda e não coleta dados pessoais de crianças. Os pais podem ativar um modo família."},
        ...
        {"q": "A app de caça ao tesouro custa alguma coisa?",
         "a": "Não. As funções de caça ao tesouro (deixar Echos, encontrar Echos, criar missões) são totalmente gratuitas. Opcionalmente, há cosméticos a partir de R$ 4,90 — sem vantagem no jogo. Pagamento via PIX."},
        {"q": "Funciona em cidades pequenas?",
         "a": "Sim. Mesmo em cidades pequenas ou bairros, você pode deixar Echos e criar missões. Em centros maiores você encontra mais rastros de outros jogadores; no interior, sua tour tem mais espaço próprio."},
        {"q": "O app é em português?",
         "a": "Sim. MapRaiders é totalmente localizado em português brasileiro — menus, sistema de Echos, dicas, suporte."},
    ],
    "internal_links": [
        ("/pt-br/alternativa-pokemon-go-gratis.html", "Alternativa Pokémon GO grátis"),
        ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
...
K7 = {
    ...
    "pricing_pill": "Free Forever · 52 milhões de cachorros no BR",
    "h1_html": 'Jogo passear cachorro — <em>território com seu pet</em>',
    "lead": "O Brasil tem mais de 52 milhões de cachorros. O passeio diário é ritual sagrado, mas vira monotonia depois de um mês. MapRaiders gamifica essa rotina: cada passeio conquista território, encontra Echos de outros tutores, forma clã orgânico no bairro. Sem AR, sem propaganda, sem propaganda direcionada — pet-friendly de verdade.",
    "trigger": {
        "quote": "Meu cachorro adora o passeio — e eu adoro que cada passeio torna meu bairro mais visível no mapa. Já conquistei minha rua toda.",
    ...
    <ul>
      <li><strong>Motivação para o passeio.</strong> Depois de meses, o passeio das 7h vira obrigação — não diversão.</li>
    ...
    "faq": [
        {"q": "Posso passear meu cachorro e jogar ao mesmo tempo sem perigo?",
         "a": "Sim. O app é desenhado para uso de bolso — você não precisa ficar olhando a tela. Notificações por som ou vibração avisam quando algo importante acontece. O passeio continua sendo do cachorro; o jogo é em segundo plano."},
        {"q": "Funciona com cachorro pequeno e idoso, devagar?",
        ...
        {"q": "Meu cachorro precisa estar registrado?",
         "a": "Não. Não exigimos cadastro do animal. Você pode opcionalmente adicionar nome e foto do pet no perfil — privado, não vendido a marcas de ração."},
        ...
        {"q": "Tem propaganda de marcas pet?",
         "a": "Não. MapRaiders é 100% sem propaganda — nem de pet shops, nem de ração, nem de nada. Pet-friendly de verdade."},
    ],
    "internal_links": [
        ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
        ("/pt-br/jogo-de-territorio.html", "Jogo de território real"),
...
TWINS_DATA = [
    {
        ...
        "lead": "Três testadores beta de três regiões metropolitanas alemãs usaram o MapRaiders por várias semanas. Aqui os relatos sem filtro — sem marketing-talk, sem código de influencer.",
        "intro_label": "Quem testou?",
        "intro_title": "Três pessoas, três <em>casos de uso</em>",
        "intro_body": """
    <p>Os três testadores beta cobrem três personas muito diferentes — e é isso que torna a comparação com Pokémon GO honesta:</p>
    <ul>
      <li><strong>Ron C.</strong> da região de Stuttgart: tutor de cachorro, passeio diário, sem background gamer.</li>
      <li><strong>Vivian N.</strong> da região de Hamburgo: corredora, jogou Pokémon GO em 2018 e parou após 3 meses.</li>
    ...
    <p>Os três testaram o MapRaiders independentemente — sem promoção paga, sem script. As citações foram traduzidas dos originais em alemão.</p>
        """,
        "internal_links": [
            ("/pt-br/alternativa-pokemon-go-gratis.html", "Alternativa Pokémon GO grátis"),
            ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
    ...
    },
    {
        ...
        "lead": "Quão preciso é GPS em centros urbanos? Quanta bateria o app consome em rotas longas? Como se sente a compatibilidade LGPD na pele de jogador? Três testadores respondem honestamente.",
    ...
    },
    {
        ...
        "lead": "Como é conquistar uma rua de verdade? Três testadores beta relatam o primeiro território, o primeiro choque de Decay e o primeiro mini-jogo de defesa.",
    ...
    <ul>
      <li><strong>Conquista.</strong> Quando a primeira rua se sente como &ldquo;minha terra&rdquo;?</li>
      <li><strong>Perda.</strong> Como reagir ao primeiro Decay ou à primeira derrota para um atacante?</li>
      <li><strong>Defesa.</strong> Como se sentem os mini-jogos de defesa — táticos, justos, frustrantes?</li>
    </ul>
    <p>As citações dos três testadores cobrem todos os três eixos sob perspectivas muito diferentes.</p>
        """,
        "internal_links": [
            ("/pt-br/jogo-de-territorio.html", "Jogo de território real"),
            ("/pt-br/jogo-de-gps.html", "Melhor jogo de GPS 2026"),
    ...
    },
    {
        ...
        "lead": "Pokémon GO no Brasil tem um problema: muitos jogadores recorrem a fake GPS. Como se sente jogar um GPS MMO que elimina essa necessidade na raiz? Três testadores beta respondem.",
    ...
    },
    {
        ...
        "lead": "O que acontece com a motivação de caminhar quando cada percurso defende terra real? Como se sente o primeiro Decay após uma pausa por gripe? Três testadores beta — uma corredora, um walker, um explorador urbano — respondem.",
        "intro_label": "Eixos do teste",
    ...
    },
    {
        ...
        "meta": "Avaliações de app de caça ao tesouro sem comprar tour ou preparação: testadores beta relatam como o MapRaiders transforma a cidade inteira em caça ao tesouro ao vivo.",
        ...
        "lead": "A maioria dos apps de caça ao tesouro exige preparação: comprar tour, planejar rota, montar estações. Como se sente quando a cidade inteira já vem cheia de pistas? Três testadores beta respondem.",
        "intro_label": "Pergunta do teste",
    ...
    <ul>
      ...
      <li><strong>Cenário familiar</strong> simulado — quão rápido adultos + crianças entendem a mecânica?</li>
    </ul>
        """,
        "internal_links": [
            ("/pt-br/caca-ao-tesouro-app.html", "Caça ao tesouro app"),
    ...
    },
    {
        ...
        "lead": "Como é gamificar o passeio diário sem distrair o cachorro? Como se forma comunidade pet num bairro onde tutores não se conhecem? Tutores beta respondem.",
        "intro_label": "Eixos do teste",
...
HUB = {
    ...
    "meta": "MapRaiders avaliações: 5,0 de 5 estrelas em três beta-tests verificados, statement do fundador, todas as páginas Killer e relatos de avaliação centralmente linkados.",
    "keywords": "mapraiders avaliacoes, mapraiders avaliacao, mapraiders teste, gps mmo avaliacoes brasil",
    "badge": "Hub & Visão geral",
    "pricing_pill": "5,0 / 5 — 3 avaliações verificadas da beta",
    "h1_html": '<em>MapRaiders avaliações</em> — tudo o que você precisa saber sobre o GPS MMO',
    ...
    "faq": [
        {"q": "O que é MapRaiders, afinal?",
         "a": "MapRaiders é um GPS MMO para Android. Jogadores conquistam territórios reais por movimento, deixam Echos, criam missões e defendem sua terra com mini-jogos. Sem propaganda, LGPD-compatível, gratuito. Pagamento PIX para cosméticos."},
        {"q": "Quantos testadores beta são?",
         "a": "Atualmente três pessoas que tornamos públicas — com consentimento delas e sob primeiro nome + inicial por motivos de privacidade. A beta fechada como um todo é maior; os três citados representam as personas principais."},
        {"q": "As avaliações são reais?",
         "a": "Sim. Os três testadores são pessoas reais da beta fechada na Alemanha. Não foram pagos; suas citações foram originalmente escritas em alemão e traduzidas para o português brasileiro. No markup Schema.org estão marcadas com data, idioma e referência ao original alemão (translationOfWork)."},
        {"q": "Onde posso ser testador beta no Brasil?",
         "a": "Cadastre-se na página inicial brasileira com seu e-mail. Vagas de beta brasileiras serão liberadas em ondas após o lançamento principal — prioridade para tutores de cachorro, corredores e exploradores urbanos de cidades com baixa densidade Pokémon GO."},
        {"q": "Quando o app sai oficialmente no Brasil?",
         "a": "MapRaiders está em beta fechada no Google Play (Alemanha). Lançamento BR oficial planejado para inverno de 2026 (julho-agosto BR). iOS no Q3 2026."},
    ],
    "internal_links": [],
}
