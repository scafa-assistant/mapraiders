...
TESTER_RON = {
    ...
    "quote": "كلبي يحتاج للخروج مرتين يومياً على أي حال، فصرت آخذ التطبيق معي. يبدو الأمر تافهاً، لكني أنظر كل مساء بسرعة لأتأكد أن الحي ما زال أزرق.",
    "date": "2026-03-15",
    "id": "review-ron-c",
}
TESTER_VIVIAN = {
    ...
    "quote": "أركض كل صباح أصلاً، لكني الآن أدافع عن شيء أيضاً. مساري حول بحيرة الألستر صار لي، وأريد أن يبقى كذلك. غريب كم يحرك هذا الانضباط فجأة.",
    "date": "2026-03-22",
    "id": "review-vivian-n",
}
TESTER_ALJOSCHA = {
    ...
    "quote": "تترك تسجيلاً صوتياً قصيراً عند مدخل بناية، وبعد ثلاثة أيام يجده شخص لا تعرفه. الإحساس حميمي بشكل غريب على لعبة.",
    "date": "2026-04-01",
...
FOUNDER_QUOTE = (
    "لعبت بوكيمون جو ثلاث سنوات وتوقفت في وقت ما. ما كنت أنتظره لم يصل أبداً: "
    "أرض حقيقية بدلاً من جيمات عابرة. حين قُدِّم بوكيمون جو لشركة أكبر سنة 2025، "
    "صار واضحاً أن مسار نياتنتيك ليس المسار الذي يهمني. لذلك أبني MapRaiders بنفسي. "
    "بدون إعلانات، بدون ضغط مستثمرين، بدون اشتراك إلزامي. حيي ميداني، "
    "وحيك يمكن أن يكون ميدانك أنت أيضاً."
)
...
{cards}
    ...
    <p style="margin-top:24px;font-size:12px;color:var(--dim);max-width:680px;line-height:1.85">
      ملاحظة: المختبرون مشاركون داخليون في النسخة التجريبية المغلقة. الأصل بالألمانية، ويُشار إليه في Schema بـ <code>translationOfWork</code>. نستخدم الاسم الأول والحرف الأول فقط بناءً على رغبة المختبرين لأسباب تتعلق بالخصوصية.
    </p>
  </div>
</section>"""
...
<div class="mx">
  ...
  <p class="f-copy">&copy; 2026 MapRaiders. حيّك، منطقتك. منتج من Scafa Investments LLC.</p>
</div>
</footer>
<script>
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">5.0 من 5 من <em>ثلاثة تقييمات تجريبية</em></h2>
  <div class="prose rv d2">
    <p>رون يخرج كلبه يومياً، فيفيان تركض في الصباح، أليوشا يمشي برلين على قدميه. الثلاثة استخدموا MapRaiders ضمن روتينهم الطبيعي لعدة أسابيع وكتبوا ملاحظاتهم بالألمانية. لأسباب تتعلق بالخصوصية، نستخدم الاسم الأول والحرف الأول فقط.</p>
  </div>
</div>
</section>"""
...
<div class="mx">
  ...
  <div class="prose rv d2">
    <p>هنا تجد جميع صفحات MapRaiders السبع الرئيسية إلى جانب سبعة تقارير تجريبية تنظر إلى التطبيق من زوايا مختلفة: المكمّل لبوكيمون جو، لعبة رمضان، لعبة الموقع، ألعاب رؤية 2030. كل صفحة قائمة بذاتها، ومعاً ترسم الصورة الكاملة.</p>
  </div>
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">ما يحكيه المختبرون من <em>زوايا مختلفة</em></h2>
  <div class="features-grid">
{twin_cards}
  </div>
</div>
...
<div class="mx">
  ...
  <h2 class="sec-title rv d1">5.0 من 5 من <em>ثلاثة تقييمات تجريبية</em></h2>
  <div class="prose rv d2">
    <p>التقييمات من النسخة التجريبية المغلقة بين فبراير وأبريل 2026. رون اختبر في شتوتغارت، فيفيان في هامبورغ، أليوشا في برلين. الثلاثة استخدموا اللعبة على مساراتهم الفعلية، لا في بيئة اختبار اصطناعية. التعليقات الأصلية بالألمانية وتمثل أشخاصاً حقيقيين.</p>
  </div>
</div>
</section>"""
...
K1 = {
    ...
    "og_title": "لعبة المنطقة، تطبيق MapRaiders",
    "meta": "لعبة منطقة بالعربية: امشِ في شوارع حيك واحتلّها، دافع عنها بألعاب صغيرة، شكّل عشيرة مع جيرانك. مجاني، خفيف على البطارية، مناسب للعائلة.",
    "keywords": "لعبة المنطقة, لعبة أراضي, GPS, MMO, لعبة موقع, لعبة عربية, MapRaiders",
    "badge": "لعبة المنطقة",
    "pricing_pill": "مجاني، وعناصر تجميلية اختيارية من ر.س ٧",
    "h1_html": 'لعبة المنطقة: <em>احتلّ حيك الحقيقي</em> بالعربية',
    "lead": "تحوّل MapRaiders خريطة GPS إلى مساحة فعلية يمكنك امتلاكها. امشِ في شوارع حيك لتسجّلها باسمك، دافع عنها بألعاب صغيرة عند الهجوم، وشكّل عشيرة مع جيرانك بشكل طبيعي. بالعربية بالكامل، خفيفة على البطارية، بدون إعلانات.",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p><strong>لعبة المنطقة</strong> هي لعبة تحتل فيها مساحات حقيقية على الخريطة، تحافظ عليها، وتوسّعها. تختلف عن ألعاب الموقع التقليدية في أن المنطقة <strong>تبقى لك بشكل دائم</strong>، وليست مجرد نقطة عابرة.</p>
    ...
    <ul>
      ...
      <li><strong>التلاشي.</strong> المناطق المهجورة تتقلص مع الوقت، فلا أحد يحتكر إلى الأبد.</li>
    ...
    <div class="feat-card rv"><h3>الاحتلال</h3><p>تمشي أو تركض أو تركب الدراجة في الشوارع، فيُرسم مسارك كمضلع منطقة على الخريطة باسمك أنت.</p></div>
    ...
    <div class="feat-card rv d2"><h3>ألعاب دفاع مصغرة</h3><p>إكس-أوه، حجر ورقة مقص، شطرنج مصغر. سبع ألعاب تحدد المعركة بالاستراتيجية لا بالوقت.</p></div>
    <div class="feat-card rv d3"><h3>مناطق العشيرة</h3><p>عدة لاعبين يتقاسمون منطقة واحدة. مناطق العشيرة أقوى ولا يستطيع مهاجم وحيد كسرها.</p></div>
        ...
        },
        {
            ...
            "body": """
    <p>بوكيمون جو لعبة موقع راسخة وتجربة مكتملة. MapRaiders ليست بديلاً لها بل مكمّلاً، تضيف بُعد <strong>المنطقة الحقيقية الدائمة</strong> الذي لم تُغطه ألعاب الموقع الأخرى.</p>
    <p>اللعب بالاثنين معاً ممكن وموصى به. تخرج للنزهة، تصطاد بوكيمون عابراً، وفي الوقت نفسه تسجّل خطواتك كمنطقة دائمة. لا حاجة للاختيار.</p>
            """,
        },
    ],
    "faq": [
        {"q": "ما هي لعبة المنطقة؟",
         "a": "هي لعبة تحتل فيها مساحات حقيقية على الخريطة وتحافظ عليها مع الوقت. في MapRaiders، عندما تمشي في شارع، يصبح ذلك الشارع منطقتك المسجلة على خريطة GPS، وتبقى لك حتى يستعيدها لاعب آخر."},
        ...
        {"q": "هل اللعبة بالعربية بالكامل؟",
         "a": "نعم. كل النصوص والقوائم والأصداء وأسماء المهام والإشعارات بالعربية الفصحى. واجهة RTL كاملة، لا إنجليزية مدسوسة."},
        {"q": "هل تعمل في رمضان والمناسبات الدينية؟",
         "a": "نعم. هناك صفحة مخصصة للعبة رمضان، ووضع خاص للمشي بعد الإفطار وقبل التراويح. اللعبة تحترم الأوقات والتقاليد المحلية."},
    ],
    "internal_links": [
        ("/ar/location-game.html", "لعبة موقع: أفضل سبع"),
...
K2 = {
    ...
    "title": "لعبة موقع: أفضل سبع ألعاب GPS بالعربية 2026",
    "og_title": "لعبة موقع: أفضل سبع ألعاب GPS بالعربية",
    "meta": "أفضل سبع ألعاب موقع GPS بالعربية في 2026: مقارنة بين MapRaiders وبوكيمون جو وIngress وPikmin وGeocaching. مجاني، مناسب للعائلة.",
    "keywords": "لعبة موقع, ألعاب GPS, لعبة GPS عربية, ألعاب الموقع, لعبة خريطة, لعبة عربية ٢٠٢٦",
    "badge": "أفضل سبع ألعاب موقع",
    "pricing_pill": "MapRaiders مجاني، وعناصر تجميلية اختيارية",
    "h1_html": 'لعبة موقع: أفضل <em>سبع ألعاب GPS</em> بالعربية 2026',
    "lead": "تبحث عن لعبة موقع GPS بالعربية؟ في 2026 توجد خيارات متعددة: بوكيمون جو، Ingress، Geocaching، Pikmin، Monster Hunter Now، Wokamon. لكل واحدة نقاط قوتها. تركيز MapRaiders هو الجمع بين منطقة دائمة، GPS بدون AR، عربية كاملة، ووضع عائلي. قارن واختر ما يناسبك.",
    "trigger": {
        "quote": "اكتشف حيك الحقيقي.",
        "author": "MapRaiders، رؤية الفريق"
    },
    ...
    "sections": [
        {
            "label": "كيف تختار",
            "title": "<em>ثلاثة معايير</em> لاختيار لعبة موقع",
            "body": """
    ...
    <ul>
      ...
      <li><strong>حاجة AR.</strong> ألعاب AR تستهلك البطارية بسرعة وتحتاج كاميرا، وليست عملية في الحرارة الشديدة.</li>
      <li><strong>اللغة العربية.</strong> هل اللعبة عربية بالكامل بواجهة RTL ونصوص أصلية، أم ترجمة جزئية؟</li>
    </ul>
            """,
        },
        {
            "label": "المقارنة",
            "title": "<em>أفضل سبع</em> ألعاب موقع 2026",
            "body": "<p>كل لعبة لها قوتها الخاصة. MapRaiders تركز على المنطقة الدائمة، بوكيمون جو على المجموعة، وكل واحدة تستحق التقدير لما تقدمه:</p>",
    ...
    <tbody>
      ...
      <tr><td>7</td><td class="feat-name">Wokamon</td><td>Wokamon Inc.</td><td>إنجليزية</td><td class="cross">✗</td><td class="check">✓</td></tr>
        ...
        },
        {
            ...
            "body": "",
            "extra": """  <div class="features-grid">
    <div class="feat-card rv"><h3>عربية بالكامل</h3><p>كل النصوص والقوائم والتنبيهات وأسماء المهام والأصداء بالعربية الفصحى. واجهة RTL أصلية، لا ترجمة مدسوسة.</p></div>
    <div class="feat-card rv d1"><h3>وضع رمضان</h3><p>إعدادات خاصة لمواعيد السحور والإفطار والتراويح. مساراتك في رمضان لها معنى إضافي.</p></div>
    <div class="feat-card rv d2"><h3>مكمّل لبوكيمون جو</h3><p>لا تحتاج للاختيار. العب الاثنين معاً، فمنطقتك الدائمة في MapRaiders، والمجموعة العابرة في بوكيمون جو.</p></div>
    <div class="feat-card rv d3"><h3>عائلي وآمن</h3><p>بدون إعلانات ولا شات مفتوح ولا مغامرات في الأماكن الحساسة. مناسب للأطفال والكبار.</p></div>
    <div class="feat-card rv d4"><h3>خفيف على البطارية</h3><p>GPS فقط، بدون AR ولا كاميرا. تدوم نزهتك حتى في حر الصيف دون قلق على الشحن.</p></div>
  </div>""",
        },
        {
            "label": "حالات استعمال",
    ...
    <ul>
      ...
      <li><strong>المشي العائلي.</strong> الكورنيش والحدائق والأحياء الآمنة، للأطفال والكبار معاً، بدون شاشات إضافية.</li>
    </ul>
            """,
        },
    ],
    "faq": [
        {"q": "ما الفرق بين لعبة الموقع ولعبة GPS؟",
         "a": "لعبة GPS تستخدم موقعك للحركة داخل اللعبة. لعبة الموقع مصطلح أوسع يشمل أي لعبة تربط الواقع بالخريطة. MapRaiders تجمع الاثنين: لعبة GPS من نوع MMO تجعل المنطقة الحقيقية ملكاً دائماً لك."},
        {"q": "هل MapRaiders مجانية؟",
         "a": "نعم. اللعب مجاني تماماً. العناصر التجميلية اختيارية (من ر.س 7 إلى ر.س 40) ولا تؤثر على اللعب. لا توجد صناديق غنائم ولا اشتراك إلزامي."},
        ...
        {"q": "هل يمكنني لعبها مع بوكيمون جو في نفس الوقت؟",
         "a": "نعم، وهذا هو المسار الأفضل في الواقع. MapRaiders مكمّل لبوكيمون جو. اخرج للنزهة وافتح كلتا اللعبتين، اصطد بوكيمون عابراً واحتلّ شوارع حقيقية بشكل دائم."},
        {"q": "هل اللعبة مناسبة للأطفال والعائلة؟",
         "a": "نعم. لا توجد إعلانات ولا شات مفتوح. المهام مناسبة لجميع الأعمار، والوضع العائلي يقيّد المسارات إلى الأحياء الآمنة. تصلح للنزهات العائلية بعد الإفطار."},
    ],
    "internal_links": [
...
K3 = {
    ...
    "meta": "تلعب بوكيمون جو؟ MapRaiders لعبتك المكملة: منطقة حقيقية دائمة، أصداء صوتية، عشيرة من الجيران. تعمل مع بوكيمون جو في النزهة نفسها، وخفيفة على البطارية.",
    ...
    "lead": "تلعب بوكيمون جو وتستمتع بها؟ ممتاز. MapRaiders ليست بديلاً ولا منافساً، بل <strong>لعبتك المكملة</strong> التي تضيف بُعداً مختلفاً. منطقة حقيقية دائمة، أصداء صوتية في الأماكن، عشيرة من جيرانك. خفيفة على البطارية لأنها بدون AR، فيمكن تشغيلها مع بوكيمون جو في النزهة نفسها.",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p>كثير من المقارنات تضع ألعاب الموقع في معركة مع بعضها: «أيّها أفضل؟» نحن نختار طريقاً مختلفاً. بوكيمون جو لعبة راسخة بفلسفتها الخاصة: مجموعة، جيمات، رايدات. MapRaiders لها فلسفة أخرى: منطقة دائمة، أصداء، عشائر عضوية.</p>
    <p>هذه ليست مقارنة «أيّها أفضل»، بل اعتراف بأن <strong>كل لعبة تخدم نوعاً مختلفاً من اللاعبين ومن الأوقات</strong>. الاثنان يتعايشان بسلام في هاتفك.</p>
            """,
        },
        {
    ...
    <div class="feat-card rv d1"><h3>أثناء المشي</h3><p>بوكيمون جو في الخلفية لتجمّع المشي. MapRaiders ترسم خطواتك كمنطقة دائمة. الاثنان معاً يعملان دون تعارض.</p></div>
    <div class="feat-card rv d2"><h3>الجيم في مقابل المنطقة</h3><p>عند الجيم، شغّل بوكيمون جو لمعركة AR. ثم أغلقها واترك صدى صوتياً للزوار التاليين عبر MapRaiders.</p></div>
    <div class="feat-card rv d3"><h3>البطارية</h3><p>بوكيمون جو يستهلك البطارية بشدة بسبب AR. أغلقه أحياناً واعتمد على MapRaiders فقط لتطول النزهة.</p></div>
  </div>""",
        },
        {
    ...
    <div class="feat-card rv d1"><h3>أصداء صوتية</h3><p>اترك رسالة صوتية أو صورة في مكان جميل. الزوار التاليون يكتشفونها، فيتحول الحي بأكمله إلى لعبة بحث عن الكنز.</p></div>
    <div class="feat-card rv d2"><h3>عشيرة من الجيران</h3><p>عشائر بوكيمون جو افتراضية وعالمية. عشائر MapRaiders عضوية، فمن يمشي شارعك يصبح حليفك الطبيعي.</p></div>
    <div class="feat-card rv d3"><h3>ألعاب دفاع مصغرة</h3><p>بوكيمون جو معاركها بأسلوب AR. في MapRaiders المعركة لعبة فكرية صغيرة، تحسم القرار بالاستراتيجية لا بقوة الكاميرا.</p></div>
  </div>""",
        },
        {
            "label": "مقارنة هادئة",
    ...
    <tbody>
      ...
      <tr><td class="feat-name">اللعب جنباً إلى جنب</td><td colspan="2" class="check">موصى به، فالاثنان مكملان</td></tr>
    </tbody>
  </table>""",
        },
    ],
    "faq": [
        {"q": "هل عليّ ترك بوكيمون جو لاستخدام MapRaiders؟",
         "a": "لا، أبداً. الفكرة كلها أن تلعب الاثنين معاً. بوكيمون جو لجمع المخلوقات والجيمات، وMapRaiders للمنطقة الدائمة والأصداء. كلتاهما تكمل الأخرى."},
        ...
        {"q": "ما الذي يضيفه MapRaiders فعلياً؟",
         "a": "أربعة أبعاد غير موجودة في بوكيمون جو: منطقة دائمة على الخريطة باسمك، أصداء صوتية وصور تتركها للزوار التاليين، عشيرة عضوية من الجيران الفعليين، وألعاب دفاع مصغرة استراتيجية."},
        {"q": "هل MapRaiders بالعربية بالكامل؟",
         "a": "نعم، عربية فصحى أصلية بـ RTL كامل، ليست ترجمة. القوائم والإشعارات وأسماء المهام وحتى الأصداء كلها بالعربية بشكل طبيعي."},
        {"q": "متى تطلق MapRaiders في الخليج والشرق الأوسط؟",
         "a": "MapRaiders حالياً في النسخة التجريبية المغلقة على Google Play. الإطلاق العام مخطط له في 2026. سجّل بريدك ليصلك تنبيه الإطلاق فور توفر اللعبة في منطقتك."},
    ],
    "internal_links": [
        ("/ar/territory-game.html", "لعبة المنطقة"),
        ("/ar/location-game.html", "لعبة موقع: أفضل سبع"),
...
K4 = {
    ...
    "badge": "موسم رمضان",
    "pricing_pill": "مجاني، بدون إعلانات، مناسب للعائلة",
    "h1_html": 'لعبة رمضان: <em>مشي بعد الإفطار</em>، بدون إعلانات',
    "lead": "رمضان موسم خاص بكل تفاصيله: صلاة وصيام وتأمل ولقاء العائلة. وكذلك المشي بعد الإفطار، الزيارات بين البيوت، النزهات قبل التراويح. تتيح MapRaiders تحويل هذه الخطوات الموسمية إلى تجربة جميلة: منطقتك تنمو مع نزهات الإفطار، عائلتك تشارك معك، وكل شارع له معنى. بدون إعلانات أو ضغط، وباحترام كامل لروحانية الموسم.",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p>رمضان ليس مجرد شهر صيام، بل إيقاع مختلف للحياة. الصباح للراحة، النهار للعمل والصلاة، المساء للعائلة والزيارات. وبعد الإفطار يتحرك الناس: نزهة قصيرة لاستعادة النشاط قبل التراويح، أو مشي عائلي مع الأطفال في الشوارع المنعشة بعد المغرب.</p>
    <p>هذه الخطوات لها قيمة بحد ذاتها، اجتماعياً وصحياً وروحياً. MapRaiders لا تضيف ضغطاً عليها بل <strong>تجعلها أكثر معنى</strong>، فكل شارع تمر به في نزهة الإفطار يصبح جزءاً من منطقتك.</p>
            """,
        },
        {
            ...
            "body": "",
            "extra": """  <div class="features-grid">
    <div class="feat-card rv"><h3>توقيت السحور والإفطار</h3><p>اللعبة تتعرف على توقيت بلدك في المملكة والإمارات ومصر والمغرب. تنبيهاتها تتوقف قبل الإفطار وأثناء التراويح.</p></div>
    ...
    <div class="feat-card rv d2"><h3>نزهة العائلة</h3><p>وضع عائلي خاص يقتصر فيه المسار على الشوارع الآمنة قرب البيت. الأطفال يساهمون بمنطقة العائلة.</p></div>
    ...
    <ul>
      <li><strong>الأطفال (8 سنوات فأكبر).</strong> يمسكون الهاتف، يفتحون اللعبة، يحتلون الشوارع، ويتعلمون الجغرافيا بصرياً.</li>
      <li><strong>الكبار.</strong> يتنافسون بلطف على عشيرة الحي ويلتقون بالجيران بشكل عضوي.</li>
      <li><strong>الجدات والأجداد.</strong> اللعبة بسيطة وعربية بالكامل، فشاركهم بنزهة قصيرة بعد المغرب.</li>
      <li><strong>الأخوات والأخوة.</strong> تحدي ودّي على من يحتل أكثر شارع في الأسبوع الأخير من رمضان.</li>
    </ul>
            """,
        },
        {
            ...
            "body": """
    <p>اللعبة لا تتوقف بنهاية رمضان. وضع العيد يحتفل بمسارات الموسم، ويحفظ منطقتك الرمضانية في «أرشيف الموسم»، فيمكنك زيارته في رمضان القادم للمقارنة. التطبيق يحترم خصوصية اللاعبين العرب: لا بيانات تُباع، ولا إعلانات تُعرض في الأماكن الحساسة، ولا مشاركة قسرية.</p>
            """,
        },
    ],
    "faq": [
        ...
        {"q": "هل MapRaiders مجانية في رمضان؟",
         "a": "نعم، اللعبة مجانية بالكامل في رمضان وغيره. لا توجد عروض «رمضان حصري» مدفوعة، ولا اشتراكات إلزامية، ولا إعلانات. الموسم نفسه يكفي بهجة."},
...
K5 = {
    ...
    "lead": "العائلات العربية تبحث عن أنشطة تجمع الكبار والصغار، بعيداً عن الشاشات الفردية، وقريبة من الحياة الواقعية. تطبيق MapRaiders يحوّل المشي العائلي إلى مغامرة لطيفة. الأطفال يحتلون شوارع الحي، الكبار يكتشفون أماكن معروفة في كورنيش جدة وبوليفارد الرياض وحدائق الإمارات. مجاني، عربي بالكامل، آمن.",
    "trigger": {
        "quote": "للعائلة كلها، بأقل وقت أمام الشاشة.",
        "author": "MapRaiders للعائلات"
    },
    "testers": [TESTER_VIVIAN, TESTER_ALJOSCHA],
    "sections": [
        {
            ...
            "body": """
    <p>الأطفال والمراهقون في الخليج يقضون 6 إلى 8 ساعات يومياً أمام الشاشات (دراسات صحية محلية 2024). الوالدان يبحثان عن طرق لإخراج الأطفال من البيت دون مقاومة. لكن المشي «العادي» ممل بنظر الأطفال، فلا تحدي ولا متعة ولا قصة.</p>
    <p>MapRaiders تحل هذه المعادلة. الأطفال يمشون لأن «الحي يصبح ملكهم»، والأم والأب يكتشفان أن المشي ممتع دون أن يكون مهمة تربوية.</p>
            """,
        },
        {
            "label": "أداة العائلة",
            ...
            "body": "",
            "extra": """  <div class="features-grid">
    <div class="feat-card rv"><h3>حساب عائلي</h3><p>الوالد والوالدة والأطفال يشاركون منطقة العائلة نفسها. خطوات الجميع تُحسب لمنطقة الأسرة.</p></div>
    <div class="feat-card rv d1"><h3>وضع الأطفال</h3><p>المسارات تقتصر على الشوارع الآمنة قرب البيت. لا مغامرة في أحياء بعيدة، والإشعارات لطيفة وملونة.</p></div>
    <div class="feat-card rv d2"><h3>تحديات يومية</h3><p>«اليوم: أكمل 1000 خطوة كعائلة»، أو «اكتشف صدى جديداً». الكل يتعاون.</p></div>
    <div class="feat-card rv d3"><h3>بدون شات مفتوح</h3><p>لا دردشة مع غرباء. التواصل محدود بقائمة الأصدقاء التي يوافق عليها الوالدان.</p></div>
  </div>""",
        },
        {
            "label": "أماكن مفضلة",
    ...
    <ul>
      ...
      <li><strong>الأبوان يتحكمان.</strong> قائمة الأصدقاء وأوقات اللعب ونطاق المسار، كله بإذن الوالدين.</li>
    </ul>
            """,
        },
    ],
...
K6 = {
    ...
    "meta": "لعبة البحث عن الكنز لكل المدينة. اترك أصداء، اكتشف ما تركه الآخرون. مجاني، عربي بالكامل، مناسب للعائلة.",
    "keywords": "لعبة البحث عن الكنز, جيوكاشينغ, GPS, مغامرات, لعبة شاشة, MapRaiders",
    "badge": "بحث عن الكنز",
    "pricing_pill": "مجاني، والمدينة كلها لعبة",
    "h1_html": 'لعبة البحث عن الكنز: <em>مدينتك بأكملها</em> لعبة',
    "lead": "ألعاب البحث عن الكنز التقليدية تتطلب تخطيطاً مسبقاً: مسار محدد ونقاط مُجهَّزة وقواعد معقدة. MapRaiders تختلف. المدينة بالفعل مليئة بالأصداء، أي رسائل صوتية وصور تركها لاعبون آخرون. تكتشفها أثناء المشي، تترك أصداءك للزوار التاليين، فتتحول كل نزهة إلى كنز ينتظرك.",
    "trigger": {
        "quote": "تترك تسجيلاً قصيراً وترى من يجده.",
    ...
    "sections": [
        {
            ...
            "body": """
    <p>في عام 2026، تطورت توقعات اللاعبين من «لعبة البحث عن الكنز» بشكل ملحوظ:</p>
    <ul>
      <li><strong>الديناميكية.</strong> لا أحد يريد تخطيط مسارات مُجهَّزة. اللعبة يجب أن تكون حية، والكنوز موجودة الآن.</li>
      <li><strong>اجتماعية.</strong> الكنوز التي يتركها لاعبون آخرون أكثر إثارة من تلك التي يضعها مطور اللعبة.</li>
      <li><strong>مجانية.</strong> الجيوكاشينغ التقليدي يقفل ميزات خلف جدار الدفع. اللاعبون اليوم يفضلون التطبيقات المجانية الكاملة.</li>
    </ul>
    <p>MapRaiders تحقق المعايير الثلاثة بآلية واحدة هي نظام الأصداء.</p>
            """,
        },
        {
            "label": "المقارنة",
    ...
    <tbody>
      ...
      <tr><td class="feat-name">Adventure Lab</td><td>Niantic / Scopely</td><td class="cross">سيناريوهات معدّة</td><td class="cross">رسمي فقط</td><td class="check">✓</td></tr>
        ...
        },
        {
            ...
            "body": """
    <p>الصدى (Echo) هو رسالة تتركها في موقع حقيقي، وله ثلاثة أنواع:</p>
    <ul>
      <li><strong>صدى صوتي.</strong> 15 ثانية تسجيل صوتي. مثال: «هذا الفرع من شجرة الأرز يشكل ظلاً جميلاً وقت العصر».</li>
      <li><strong>صدى صورة.</strong> صورة تلتقطها للموقع، تُحفظ مع إحداثيات GPS الدقيقة.</li>
      <li><strong>صدى فيديو.</strong> فيديو من 5 إلى 20 ثانية. مثال: مشهد الكورنيش وقت الغروب.</li>
    </ul>
    <p>اللاعب التالي الذي يمر بمسافة 10 أمتار من الموقع يكتشف الصدى، فتغدو المدينة كلها لوحة جماعية حية.</p>
            """,
        },
        {
...
K7 = {
    ...
    "lead": "رؤية 2030 تحوّل المملكة العربية السعودية إلى وجهة رياضية وسياحية وثقافية. بوليفارد الرياض، QIDDIYA، كورنيش جدة الجديد، الدرعية التاريخية، نيوم. كلها مشاريع تستحق الاستكشاف. MapRaiders تجمع روح رؤية 2030 مع نمط حياة نشط. تمشي في هذه المعالم الجديدة، تحتلها كمناطقك، تشارك أصداءك مع المجتمع. مجانية، بالعربية، متوافقة مع نظام حماية البيانات السعودي (PDPL).",
    "trigger": {
    ...
    "sections": [
        {
            ...
            "body": """
    <p>رؤية المملكة 2030 رفعت قطاع الرياضة والترفيه إلى مرتبة الأولوية الوطنية. صندوق الاستثمارات العامة استثمر 38 مليار دولار في صناعة الألعاب وحدها. برنامج جودة الحياة يستهدف رفع نسبة الممارسين للنشاط البدني من 13% إلى 40% بحلول 2030.</p>
    <p>هذا يخلق فرصة لتطبيقات تحوّل النشاط البدني إلى متعة. MapRaiders تعمل في هذا الفضاء بالضبط، وتركز على ركن لم تتطرق إليه التطبيقات الأخرى: <strong>المعالم الجديدة لرؤية 2030 كملاعب أصلية</strong>.</p>
            """,
        },
        {
            "label": "الوجهات",
    ...
    <div class="feat-card rv d3"><h3>تحديات الموسم</h3><p>تتزامن مع موسم الرياض، موسم جدة، أيام التراث الوطنية. كل موسم له أوسمة خاصة.</p></div>
        ...
        },
        {
            ...
            "body": """
    <p>نظام حماية البيانات السعودي PDPL (Personal Data Protection Law) دخل حيز التنفيذ كاملاً في 2026. MapRaiders صُممت للامتثال ولتجاوز المتطلبات أيضاً:</p>
    <ul>
    ...
    "faq": [
        {"q": "هل MapRaiders جزء من برنامج رؤية 2030 رسمياً؟",
         "a": "MapRaiders تطبيق مستقل من Scafa Investments LLC (مقرها الولايات المتحدة)، صُمم باحترام كامل لرؤية 2030 وتطلعاتها للنمط الصحي. ليست مرتبطة رسمياً بأي جهة حكومية، لكنها متوافقة مع PDPL وتدعم أهداف برنامج جودة الحياة."},
        ...
        {"q": "هل يمكنني الانضمام لعشيرة سعودية؟",
         "a": "نعم. عشائر MapRaiders تتشكل عضوياً حسب النشاط الجغرافي. اللاعبون في الرياض ينضمون طبيعياً لعشيرة الرياض، وهكذا. كما تتوفر عشائر افتراضية كبرى لمن يفضلها."},
        {"q": "متى تطلق اللعبة في المملكة؟",
         "a": "MapRaiders حالياً في النسخة التجريبية المغلقة على Google Play. الإطلاق العام مخطط له في 2026. سجّل بريدك ليصلك تنبيه الإطلاق."},
    ],
    "internal_links": [
        ("/ar/territory-game.html", "لعبة المنطقة"),
        ("/ar/location-game.html", "لعبة موقع: أفضل سبع"),
...
TWINS_DATA = [
    {
        ...
        "meta": "تجارب فعلية للعبة المنطقة من ثلاثة مختبرين تجريبيين. كيف عاشوا أول احتلال، أول تلاشي، أول معركة دفاع.",
        "keywords": "تجربة لعبة المنطقة, تجارب MapRaiders, مراجعات",
        "h1_html": 'تجربة <em>لعبة المنطقة</em>: أصوات المختبرين',
        "lead": "كيف يبدو احتلال شارع حقيقي؟ ثلاثة مختبرين تجريبيين يحكون عن أول لحظة احتلال، وأول صدمة تلاشي، وأول معركة دفاع مصغرة.",
    ...
    <ul>
      ...
      <li><strong>الدفاع.</strong> ألعاب الدفاع المصغرة، هل هي استراتيجية وعادلة، أم مرهقة؟</li>
    </ul>
    ...
    },
    {
        ...
        "title": "تجربة لعبة الموقع: تجارب من ثلاث مدن",
        "og_title": "تجربة لعبة الموقع، كلمة المختبرين",
        "meta": "تجارب لعبة الموقع: ثلاثة مختبرين من شتوتغارت وهامبورغ وبرلين يحكون كيف عاشوا MapRaiders.",
        "keywords": "تجربة لعبة الموقع, مراجعات GPS, تجارب MapRaiders",
        "h1_html": 'تجربة <em>لعبة الموقع</em>: ثلاث مدن، ثلاثة أساليب',
        "lead": "ألعاب الموقع تعتمد بقوة على كثافة اللاعبين في منطقتك. ثلاثة مختبرين من ثلاث مدن ألمانية يحكون كيف اختلفت تجربتهم.",
    ...
    <ul>
      ...
      <li><strong>هامبورغ (Vivian N.).</strong> عدّاؤون قرب بحيرة الألستر، تركيز على نشاط الجري.</li>
      <li><strong>شتوتغارت (Ron C.).</strong> أصحاب الكلاب، إيقاع حي أهدأ.</li>
    </ul>
        """,
        "internal_links": [
            ("/ar/location-game.html", "لعبة موقع: أفضل سبع"),
    ...
    },
    {
        ...
        "meta": "تجارب اللعب المتوازي: ثلاثة مختبرين يحكون كيف لعبوا MapRaiders مع بوكيمون جو في النزهة نفسها.",
        "keywords": "بوكيمون جو, مكمل, MapRaiders تجربة, لعب متوازي",
        "h1_html": 'تجربة <em>بوكيمون جو + MapRaiders</em>',
        "lead": "هل يمكن اللعب بالاثنين معاً؟ ثلاثة مختبرين تجريبيين يحكون عن تجربة فتح بوكيمون جو وMapRaiders في النزهة نفسها.",
    ...
    <ul>
      ...
      <li><strong>المتعة الموسمية.</strong> الأصداء الرمضانية وتحدي الجيران، كيف تشعر بها؟</li>
...
HUB = {
    ...
    "og_title": "تجارب MapRaiders، مركز التجارب",
    "meta": "تجارب MapRaiders: 5.0 من 5 من ثلاثة تقييمات تجريبية، كلمة المؤسس، كل صفحات الموضوعات والتجارب في مكان واحد.",
    "keywords": "تجربة MapRaiders, تقييمات MapRaiders, مراجعات GPS MMO, تجارب لعبة المنطقة",
    "badge": "مركز كل التجارب",
    "pricing_pill": "5.0 من 5 من ثلاثة تقييمات تجريبية",
    "h1_html": '<em>تجارب MapRaiders</em>: كل ما يجب معرفته',
    "lead": "ثلاثة مختبرين تجريبيين من ألمانيا، سبعة موضوعات رئيسية من بوكيمون جو المكمل إلى رؤية 2030، وسبع تجارب تفصيلية. مركز واحد يجمع كل شيء.",
    "trigger": None,
    "testers": ALL_TESTERS,
    "sections": [],
    "faq": [
        {"q": "ما هي MapRaiders؟",
         "a": "MapRaiders لعبة GPS من نوع MMO لأجهزة Android. اللاعبون يحتلون مناطق حقيقية بالحركة، يتركون أصداء، ينشئون مهاماً، ويدافعون عن مناطقهم بألعاب صغيرة. مجاني، بدون إعلانات، بدون AR."},
        {"q": "كم عدد المختبرين؟",
         "a": "الثلاثة المعروضون علناً موافقون شخصياً، ويُذكرون بالاسم الأول والحرف الأول لأسباب الخصوصية. النسخة التجريبية المغلقة الكاملة أكبر، لكن الثلاثة يمثلون الشخصيات الرئيسية."},
        {"q": "هل التقييمات حقيقية؟",
         "a": "نعم. الثلاثة مشاركون فعليون في النسخة التجريبية المغلقة، ولم يتلقوا أجراً. تعليقاتهم مكتوبة أصلاً بالألمانية ومعلَّمة في Schema.org بالتواريخ واللغة."},
        ...
        {"q": "متى الإطلاق الرسمي؟",
         "a": "MapRaiders حالياً في النسخة التجريبية المغلقة على Google Play. الإطلاق الرسمي مخطط له في 2026، ونسخة iOS متوقعة في الربع الثالث 2026."},
    ],
    "internal_links": [],
}
