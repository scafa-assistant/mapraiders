...
-- ============================================================
-- SEEDS: PvE Unit item definitions (all non-tradeable)
-- ============================================================
...
-- ============================================================
-- Phase C.1 — Commander layer: Fog of War + Scouts (2026-06-12)
...
-- ============================================================
-- Phase D — Hybrid AI General (deterministic sector sim + LLM) (2026-06-12)
-- Mirrors src/db/migrations/2026-06-12_phaseD_ai.sql.
--
...
-- work UNCHANGED. Clients identify AI via that fixed id (AI.USER_ID in
-- constants.ts) and config.ai_faction === true on movements.
-- The AI user owns no territories and earns no XP, so leaderboard exposure is
-- minimal (known follow-up: explicitly exclude it if it ever surfaces).
-- ============================================================
